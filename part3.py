...
print("Expected annual return {:.2f}".format(data[0]*100)+'%')
print("Expected annual risk {:.2f}".format(data[1] * 100)+'%')
print("Sharpe Ratio {:.2f}".format(data[2])+'%')
...
st.write(shares_allocations[0,0],annotated_text((df.iloc[0,1],'Shares','color')))
