...
class regression_analysis(HydraHeadApp):
    ...
    def run(self):
        ...
        st.write(" ###### The " + str(selected_stock) + " has performed " + str(alpha_result) + " compare to S&P 500. Further in terms of volatility, it is the market which can be graphically demonstrated below: ")
