...
class home_page(HydraHeadApp):
    ...
    def run(self):
        ...
        to see selected stock's future price and **Portfolio Optimization** for allocating the capital to get higher return on selected portfolio from the navigation bar.
